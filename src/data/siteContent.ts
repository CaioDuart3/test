...
export const siteContent: SiteContent = {
  ...
  playlist: {
    provider: 'spotify',
    embedUrl: 'https://open.spotify.com/embed/track/2mdEsXPu8ZmkHRRtAdC09e?utm_source=generator',
    externalUrl: 'https://open.spotify.com/track/2mdEsXPu8ZmkHRRtAdC09e',
    title: 'Nossa Música',
    description: 'Ouça nossa música especial',
  },
